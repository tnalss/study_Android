...
public class ListSelectFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        recv_list_select.setAdapter(new SelectListAdapter(inflater,getContext()));

        recv_list_select.setLayoutManager(new LinearLayoutManager(getContext(),LinearLayoutManager.VERTICAL,false));
        return v;
    }
}